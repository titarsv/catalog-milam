<script>
    tinyMCEPreInit = {
        ...
        dragDropUpload: true,
        mceInit: {
            <?php $__currentLoopData = $editors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $editor_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($i > 0 ? ',' : ''); ?>

                '<?php echo e($editor_id); ?>':{
                    theme:"modern",
                    skin:"lightgray",
                    language:"ru",
                    formats:{
                    ...
                    entity_encoding:"raw",
                    keep_styles:false,
                    cache_suffix:"wp-mce-4800-<?php echo e(date('Ymd')); ?>",
                    resize:"vertical",
                    menubar:false,
                    branding:false,
                    ...
                    body_class:"<?php echo e($editor_id); ?> post-type-page post-status-publish page-template-page-main locale-ru-ru"
                }
...
<?php /**PATH C:\OSPanel\domains\milam.lh\resources\views/admin/layouts/mce.blade.php ENDPATH**/ ?>