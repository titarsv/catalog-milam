    ...
    <div class="form">
        <form method="post">
            ...
            <div class="panel-group">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="old_url" value="<?php echo old('old_url') ? old('old_url') : $redirect->old_url; ?>" />
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <input type="text" class="form-control" name="new_url" value="<?php echo old('new_url') ? old('new_url') : $redirect->new_url; ?>" />
                ...
                <?php if($user->hasAccess(['redirects.update'])): ?>
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
