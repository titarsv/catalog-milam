...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <?php if($user->hasAccess(['pages.create'])): ?>
            ...
            <div class="table table-responsive">
                <table class="table table-hover">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><a href="<?php echo e($page->link()); ?>" target="_blank"><?php echo e($page->name); ?></a></td>
                            <td><?php echo e($page->sort_order); ?></td>
                            <td class="status">
                                    <span class="<?php echo $page->status ? 'on' : 'off'; ?>">
                                        <span class="runner"></span>
                                    </span>
                            </td>
                            <td class="actions" align="center">
                                <?php if($user->hasAccess(['pages.view'])): ?>
                                <a class="btn btn-primary" href="/admin/pages/edit/<?php echo $page->id; ?>">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if($user->hasAccess(['pages.delete'])): ?>
                                <button type="button" class="btn btn-danger" onclick="confirmPageDelete('<?php echo $page->id; ?>', '<?php echo $page->name; ?>')">
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\milam.lh\resources\views/admin/pages/index.blade.php ENDPATH**/ ?>