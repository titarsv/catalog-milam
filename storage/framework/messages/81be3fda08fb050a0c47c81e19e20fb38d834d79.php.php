...
<?php $__env->startSection('content'); ?>
                    ...
                    <?php $__currentLoopData = $new; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="info">
                            ...
                            <td class="actions" align="center">
                                <?php if($user->hasAccess(['shopreviews.view'])): ?>
                                <a class="btn btn-primary" href="/admin/shopreviews/show/<?php echo $review->id; ?>">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if($user->hasAccess(['shopreviews.delete'])): ?>
                                <button type="button" class="btn btn-danger" onclick="confirmShopReviewDelete('<?php echo $review->id; ?>')">
    ...
    <div id="shop-reviews-delete-modal" class="modal fade" role="dialog">
