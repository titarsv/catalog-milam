...
<?php $__env->startSection('content'); ?>
                        ...
                        <div class="row">
                            <div class="col-sm-6 small-box">
                                <div class="small-box_link bg-blue">
                                    <div class="badge"><?php echo $stat['all_orders']; ?></div>
                                    <div class="link">
                            ...
                            <div class="col-sm-6 small-box">
                                <div class="small-box_link bg-blue">
                                    <div class="badge"><?php echo $stat['week_order']; ?></div>
                                    <div class="link">
                        ...
                        <div class="row">
                            <div class="col-sm-6 small-box">
                                <div class="small-box_link bg-tomato">
                                    <div class="badge"><?php echo $stat['new_orders']; ?></div>
                                    <div class="link">
                            ...
                            <div class="col-sm-6 small-box">
                                <div class="small-box_link bg-lightblue">
                                    <div class="badge"><?php echo $stat['finished']; ?></div>
                                    <div class="link">
                            ...
                            <div class="col-sm-12 small-box">
                                <div class="small-box_link sales-box bg-blue">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="badge"><?php echo $stat['total_sales']; ?> грн</div>
                                        </div>
                                    </div>
                                    <div class="link">
                            ...
                            <div class="col-sm-12 small-box">
                                <div class="small-box_link sales-box bg-lightblue">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="badge"><?php echo $stat['weekly_sales']; ?> грн</div>
                                        </div>
                                    </div>
                                    <div class="link">
    ...
    <script>
        window.onload = function(){
            ...
            order_data.push("<?php echo $order['quantity']; ?>");
            sale_data.push("<?php echo $order['sales']; ?>");
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\milam.lh\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>