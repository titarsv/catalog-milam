...
<?php $__env->startSection('content'); ?>
    ...
    <form action="/admin/seo/redirects" method="post" id="settings-form">
        <?php echo csrf_field(); ?>
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <?php if($user->hasAccess(['redirects.create'])): ?>
            ...
            <div class="table table-responsive">
                <table class="table table-hover">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $redirects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $redirect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($redirect->old_url); ?></td>
                            <td><?php echo e($redirect->new_url); ?></td>
                            <td class="actions" align="center">
                                <?php if($user->hasAccess(['redirects.view'])): ?>
                                <a class="btn btn-primary" href="/admin/seo/redirects/edit/<?php echo $redirect->id; ?>">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if($user->hasAccess(['redirects.delete'])): ?>
                                <button type="button" class="btn btn-danger" onclick="confirmSeoRedirectDelete('<?php echo $redirect->id; ?>', '<?php echo $redirect->old_url; ?>')">
