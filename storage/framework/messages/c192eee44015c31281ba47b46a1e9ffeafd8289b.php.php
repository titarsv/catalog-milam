                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="sale" name="percent" value="<?php echo e(old('percent') ? old('percent') : (old('price') ? old('price') : '')); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="code" name="code" value="<?php echo e(old('code') ? old('code') : ''); ?>" autocomplete="off">
                                ...
                                <div class="form-element col-sm-10">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <div class="radio">
                                                <label>
                                                    <input name="scope" value="all" autocomplete="off" type="radio"<?php echo e(old('scope', 'all') == 'all' ? ' checked' : ''); ?>> <b>На все товары</b>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input name="scope" value="categories" autocomplete="off" type="radio"<?php echo e(old('scope', 'all') == 'categories' ? ' checked' : ''); ?>> <b>На выбранные категории</b>
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label>
                                                    <input name="scope" value="products" autocomplete="off" type="radio"<?php echo e(old('scope', 'all') == 'products' ? ' checked' : ''); ?>> <b>На выбранные товары</b>
                                                </label>
                                            </div>
                                            <div class="js_categories"<?php echo old('scope', 'all') != 'categories' ? ' style="display: none"' : ''; ?>>
                                                <input type="hidden" name="scope_categories" value="<?php echo e(old('scope_categories')); ?>" autocomplete="off">
                                            ...
                                            <div class="js_products"<?php echo old('scope', 'all') != 'products' ? ' style="display: none"' : ''; ?>>
                                                <input type="hidden" name="scope_products" value="<?php echo e(old('scope_products')); ?>" autocomplete="off">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-2">
                                <div class="checkbox">
                                    <label>
                                        <input name="disposable" value="1" type="checkbox" autocomplete="off"<?php echo e(old('disposable', 1) ? ' checked' : ''); ?>> <b>Возможно использовать неограниченное количество раз</b>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="min_total_toggle" autocomplete="off"<?php echo e(old('min_total') ? ' checked' : ''); ?>> <b>Скидка действует при минимальной сумме заказа</b>
                                    </label>
                                </div>
                                <div class="input-group" id="min_total" style="max-width: 200px;<?php echo old('min_total') ? '' : ' display:none;'; ?>">
                                    <input type="text" class="form-control" name="min_total" value="<?php echo e(old('min_total', 0)); ?>" autocomplete="off"<?php echo old('min_total') ? '' : ' disabled'; ?>>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-2">
                                <div class="checkbox">
                                    <label>
                                        <input name="without_sale" value="1" autocomplete="off" type="checkbox"<?php echo e(old('without_sale', 1) ? ' checked' : ''); ?>> <b>Не применять промокод для товаров с действующей скидкой</b>
                                    </label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-element col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            ...
                                            <input type="text" class="form-control from" name="from" autocomplete="off" value="<?php echo e(old('from') ? old('from') : date('d.m.Y')); ?>">
                                        </div>
                                        <div class="col-sm-1 text-center with_end_date"<?php echo old('to') ? '' : ' style="display:none;"'; ?>>
                                            <br>
                                            <span style="display: block;margin-top: 15px;">-</span>
                                        </div>
                                        <div class="col-sm-2 with_end_date"<?php echo old('to') ? '' : ' style="display:none;"'; ?>>
                                            <span style="display: block;margin-bottom: 10px;">Дата окончания</span>
                                            <input type="text" class="form-control to" name="to" autocomplete="off" value="<?php echo e(old('to') ? old('to') : date('d.m.Y')); ?>"<?php echo old('to') ? '' : ' disabled'; ?>>
                                        </div>
                                    </div>
                                    <div class="checkbox">
                                        <label>
                                            <input id="with_end_date" type="checkbox"<?php echo e(old('to') ? ' checked' : ''); ?> autocomplete="off"> <b>Установить дату окончания</b>
                                        </label>
                                    </div>
                                </div>
                            </div>
