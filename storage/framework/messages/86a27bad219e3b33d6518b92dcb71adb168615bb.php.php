        ...
        <div class="container">
            <div class="header-main__wrapper">
                <div class="header-left">
                    <a href="<?php echo e(base_url('/')); ?>" class="header-logo1">
                        <picture>
                    ...
                    <a href="<?php echo e(base_url('/')); ?>" class="header-logo2">
                        <picture>
                ...
                <div class="header-mid">
                    <span><?php echo e(__('ООО Торговый Дом «Пирана»')); ?></span>
                    <small><?php echo e(__('Производство Бытовой Химии')); ?></small>
                </div>
                <div class="header-right">
                    <div class="header-region">
                        <span><?php echo e(__('Ваша область')); ?>:</span>
                        <select class="select js_region_select" autocomplete="off">
                            <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($i < 24): ?>
                                    <option value="<?php echo e($i); ?>"<?php echo e((empty($_COOKIE['region']) && $i == 8) || (!empty($_COOKIE['region']) && $i == $_COOKIE['region']) ? ' selected' : ''); ?>><?php echo e($region); ?></option>
                                <?php endif; ?>
        ...
        <div class="container">
            <div class="header-bot__wrapper">
                <ul class="header-menu">
                    <li<?php echo rtrim(env('APP_URL').'/'.request()->path(), '/') == base_url('/') ? ' class="current"' : ''; ?>>
                        <a href="<?php echo e(base_url('/')); ?>"><?php echo e(__('Главная')); ?></a>
                    </li>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li<?php echo !empty($category->children) ? '  class="has-children"' : ''; ?>>
                            <a href="<?php echo e($category->link); ?>"><?php echo e($category->name); ?>
                                ...
                                <div class="submenu">
                                    <ul>
                                        <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li<?php echo !empty($subcategory->children) ? '  class="has-children"' : ''; ?>>
                                                ...
                                                <?php if(!empty($subcategory->children)): ?>
                                                    <div class="submenu">
                                                        <ul>
                                                            <?php $__currentLoopData = $subcategory->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    <a href="<?php echo e($subcategory2->link); ?>"><?php echo e($subcategory2->name); ?></a>
                                                                </li>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </ul>
                                                        <a href="<?php echo e($subcategory->link); ?>"><?php echo e(__('Открыть всю категорию')); ?></a>
                                                    </div>
                                                <?php endif; ?>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <a href="<?php echo e($category->link); ?>"><?php echo e(__('Вся продукция')); ?></a>
                                </div>
                            <?php endif; ?>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="header-bot__nav">
                    <ul class="header-lang">
                        <?php $__currentLoopData = $locales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale => $locale_name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <?php if($locale == $current_locale): ?>
                                    <span><?php echo e($locale_name); ?></span>
                                <?php else: ?>
                                    <a href="<?php echo e(env('APP_URL')); ?><?php echo e($locale == $main_locale ? (empty($base_url) ? '/' : $base_url) : ('/'.$locale.($base_url == '/' ? '' : $base_url))); ?>"><?php echo e($locale_name); ?></a>
                                <?php endif; ?>
                            </li>
                            <?php if($locale != 'en'): ?>
                                <li>/</li>
...
<div class="mobile-menu__wrapper">
    <div class="mobile-menu__main">
        <ul class="mobile-menu">
            <li>
                <a href="<?php echo e(base_url('/')); ?>" class="current"><?php echo e(__('Главная')); ?></a>
            </li>
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li<?php echo !empty($category->children) ? '  class="has-children"' : ''; ?>>
                    ...
                    <?php if(!empty($category->children)): ?>
                        ...
                        <ul class="submenu">
                            <?php $__currentLoopData = $category->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href="<?php echo e($subcategory->link); ?>"><?php echo e($subcategory->name); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    <?php endif; ?>
                </li>
        ...
        <div class="mobile-menu__links">
            ...
            <a href="https://www.instagram.com/himia_milam" class="mobile-menu__insta">
...
</div><?php /**PATH C:\OSPanel\domains\milam.lh\resources\views/public/layouts/header.blade.php ENDPATH**/ ?>