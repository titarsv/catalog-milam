...
<?php $__env->startSection('content'); ?>
    ...
    <h1>Список отзывов о сайте пользователя <?php echo e($user->email); ?>. <br><a href="/admin/users">К списку покупателей</a></h1>
        ...
        <div class="panel panel-default">
            <div class="table table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $shopreviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="actions" align="center">
                                <a class="btn btn-primary" href="/admin/shopreviews/show/<?php echo $review->id; ?>">
