                ...
                <table class="table table-hover">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="status">
                                <span class="<?php echo $article->published ? 'on' : 'off'; ?>">
                                    <span class="runner"></span>
                                </span>
                            </td>
                            <td align="center" class="actions">
                                <?php if($user->hasAccess(['news.view'])): ?>
                                <a class="btn btn-primary" href="/admin/news/edit/<?php echo $article->id; ?>">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </a>
                                <?php endif; ?>
                                <?php if($user->hasAccess(['news.delete'])): ?>
                                <a class="btn btn-danger" href="/admin/news/delete/<?php echo $article->id; ?>">
