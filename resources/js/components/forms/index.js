            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (typeof response.status !== 'undefined' && response.status == 'success') {
                        // if(form.hasClass('config-popup__form')){
                        //     ga(ga.getAll()[0].get('name') + '.send', 'event', { eventCategory: 'form', eventAction: 'unic', eventValue: 1 });
                        // }else if(form.hasClass('consult-form')){
                        //     ga(ga.getAll()[0].get('name') + '.send', 'event', { eventCategory: 'form', eventAction: 'contact', eventValue: 1 });
                        // }else if(form.hasClass('consult-popup__form')){
                        //     ga(ga.getAll()[0].get('name') + '.send', 'event', { eventCategory: 'form', eventAction: 'consult', eventValue: 1 });
                        // }else if(form.hasClass('services-form')){
                        //     ga(ga.getAll()[0].get('name') + '.send', 'event', { eventCategory: 'form', eventAction: 'uslugi', eventValue: 1 });
                        // }
