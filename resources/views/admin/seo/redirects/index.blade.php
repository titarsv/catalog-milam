...
@section('content')
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            @if($user->hasAccess(['redirects.create']))
                    ...
                    @forelse($redirects as $redirect)
                        <tr>
                            ...
                            <td class="actions" align="center">
                                @if($user->hasAccess(['redirects.view']))
                                <a class="btn btn-primary" href="/admin/seo/redirects/edit/{!! $redirect->id !!}">
                                    <i class="glyphicon glyphicon-edit"></i>
                                </a>
                                @endif
                                @if($user->hasAccess(['redirects.delete']))
                                <button type="button" class="btn btn-danger" onclick="confirmSeoRedirectDelete('{!! $redirect->id !!}', '{!! $redirect->old_url !!}')">
