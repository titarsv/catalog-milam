                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <input type="text" class="form-control from" name="show_from" value="{{ old('show_from') ? old('show_from') : date('Y/m/d H:i', strtotime($sale->show_from)) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="form-element col-sm-10">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <input type="text" class="form-control to" name="show_to" value="{{ old('show_to') ? old('show_to') : date('Y/m/d H:i', strtotime($sale->show_to)) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
