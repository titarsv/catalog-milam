...
//	    Redis::command('FLUSHDB');
    ...
    private function redisCategoriesSync($page){
        ...
        foreach($categories as $category){
            ...
            foreach(DB::table('product_categories')->where('category_id', $category->id)->get() as $product){
                Redis::command('zadd', ['product_category_order_'.$category->id, $product->order, $product->product_id]);
            }
        }
